...
const ScopeContainer = () => {
    const right_content = [
        {
            ...
            'description': 'Профиль который хранит личные данные и проекты которые зарегистрировал или подписался.',
        },
        {
            'img': calendar_img,
            'title': 'Календарь',
            'description': 'Календарь мерропрития, на любой удобный день и время. Только актуальные данные, которые обновляются.',
        },
        {
            'img': group_img,
            'title': 'Общество',
            'description': 'Это приложение помогает в поиске людей по инетресам, с которыми вместе можно творить добрый дела.',
        },
    ]
    ...
    const left_content = [
        ...
        },
        {
            'img': project_img,
            'title': 'Проекты',
            'description': 'Возможность зарегистрировать проект или свою организацию для посика волонтеров или анонса ивентов.',
        },
    ]
